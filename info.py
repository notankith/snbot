...
API_ID = int(environ.get('26922303', ''))
API_HASH = environ.get('API_HASH', '98bdd4d6d779f387aab487bb5d050f0c')
BOT_TOKEN = environ.get('BOT_TOKEN', '6093518952:AAElm66eMlhWzptfUNTCyqbRY-e1cueJF')
...
# Bot images & videos
PICS = (environ.get('PICS', 'https://telera.ph/file/7709713d511446fce2b84.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2106671172').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001658823824').split()]
...
SUPPORT_CHAT_ID = LucaMovies
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://forinstaacc8899:anki@cluster0.hzzqwxa.mongodb.net/?")
